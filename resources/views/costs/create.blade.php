          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                ...
                <br>
                <form action="{{route('others.cost.store')}}" method="POST" id="costForm" enctype="multipart/form-data">
                       ...
                       <div class="add_item">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-3">
                             ...
                             <div class="col-md-9">
                                <textarea class="form-control" name="description" placeholder="Enter endsection"></textarea>
                              </div>
                              <div class="col-md-3">
