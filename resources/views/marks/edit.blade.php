          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                ...
                <div class="cart-body">
                     <form action="{{route('edit.store.student.marks')}}" method="POST" id="#">
                        @csrf
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-2">
                          <a id="getEdit" name="getMark" class="btn btn-info btn-sm" style="margin-top: 30px">Search</a>
                        </div>
