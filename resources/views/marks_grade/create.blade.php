      ...
      <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                ...
                <br>
                <form action="{{route('store.marks.grade')}}" method="POST" enctype="multipart/form-data">
               @csrf
                   ...
                   <div class="row">
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <input type="text" name="grade_name" class="form-control form-control-sm" id="name" placeholder="Enter Grade Name">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <input type="text" name="grade_point" class="form-control form-control-sm" id="name" placeholder="Enter Grade Point">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <input type="text" name="start_marks" class="form-control form-control-sm" id="name" placeholder="Enter Start Marks">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <input type="text" name="end_marks" class="form-control form-control-sm" id="name" placeholder="Enter End Marks">
                         ...
                         <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <input type="text" name="start_point" class="form-control form-control-sm" id="name" placeholder="Enter Start Point">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <input type="text" name="end_point" class="form-control form-control-sm" id="name" placeholder="Enter End Point">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <input type="text" name="remarks" class="form-control form-control-sm" id="name" placeholder="Enter Remarks">
                            @if($errors->has('name'))
